...
def create_class_from_module(name: str, module, args: dict | None = None):  # noqa: ANN001, ANN201, D103
    if not args:
        args = {}
...
def create_torch_module(name: str, args: dict | None = None) -> torch.nn.Module:  # noqa: D103
    return create_class_from_module(name=name, args=args, module=torch.nn)
